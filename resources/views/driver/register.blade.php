...
<form>
<input type="hidden" name="subject" value="RegisterDriver">
...
<div class="inner-holder">
<button type="submit" class="submit" id="register_driver" data-toggle='modal' data-target='#myModal'>Register</button>
</form>
